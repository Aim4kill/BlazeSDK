...
public class GameReportTypes : Tdf
{
    ...
    private TdfList<Blaze3SDK.Blaze.GameReportingLegacy.GameReportType> _gameReportTypes = new(__typeInfos[0]);
    ...
    public override string GetFullClassName() => "Blaze::GameReportingLegacy::GameReportTypes";

    public IList<Blaze3SDK.Blaze.GameReportingLegacy.GameReportType> mGameReportTypes
    {
