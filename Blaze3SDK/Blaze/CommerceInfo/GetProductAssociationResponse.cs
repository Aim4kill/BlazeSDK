...
public class GetProductAssociationResponse : Tdf
{
    ...
    private TdfList<Blaze3SDK.Blaze.CommerceInfo.ProductAssociation> _productAssociationList = new(__typeInfos[10]);
    ...
    public IList<Blaze3SDK.Blaze.CommerceInfo.ProductAssociation> ProductAssociationList
    {
