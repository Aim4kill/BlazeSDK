...
public class HostViabilityRuleStatus : Tdf
{
    ...
    private TdfEnum<Blaze3SDK.Blaze.GameManager.HostViabilityRuleStatus.HostViabilityValues> _matchedHostViabilityValue = new(__typeInfos[0]);
    ...
    public Blaze3SDK.Blaze.GameManager.HostViabilityRuleStatus.HostViabilityValues MatchedHostViabilityValue
    {
