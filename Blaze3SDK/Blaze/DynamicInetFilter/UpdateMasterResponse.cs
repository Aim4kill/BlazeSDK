...
public class UpdateMasterResponse : Tdf
{
    ...
    public override Tdf CreateNew() => new UpdateMasterResponse();
    public override ITdfMember[] GetMembers() => __members;
    public override TdfMemberInfo[] GetMemberInfos() => __typeInfos;
    public static TdfMemberInfo[] GetTdfMemberInfos() => __typeInfos;
    public override string GetClassName() => "UpdateMasterResponse";
    public override string GetFullClassName() => "Blaze::DynamicInetFilter::UpdateMasterResponse";
