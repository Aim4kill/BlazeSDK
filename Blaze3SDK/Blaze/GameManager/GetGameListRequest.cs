...
public class GetGameListRequest : Tdf
{
    ...
    private TdfStruct<Blaze3SDK.Blaze.GameManager.MatchmakingCriteriaData?> _listCriteria = new(__typeInfos[1]);
    ...
    public Blaze3SDK.Blaze.GameManager.MatchmakingCriteriaData? ListCriteria
    {
