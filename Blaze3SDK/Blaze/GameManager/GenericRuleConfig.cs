...
public class GenericRuleConfig : Tdf
{
    ...
    private TdfEnum<Blaze3SDK.Blaze.GameManager.GenericRuleConfig.GenericRuleAttributeType> _attributeType = new(__typeInfos[1]);
    ...
    public Blaze3SDK.Blaze.GameManager.GenericRuleConfig.GenericRuleAttributeType AttributeType
    {
