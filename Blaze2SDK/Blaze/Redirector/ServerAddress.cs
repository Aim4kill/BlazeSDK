...
public class ServerAddress : Union
{
    ...
    private TdfStruct<Blaze2SDK.Blaze.Redirector.IpAddress?> _ipAddress = new(__typeInfos[0]);
    private TdfStruct<Blaze2SDK.Blaze.Redirector.XboxServerAddress?> _xboxServerAddress = new(__typeInfos[1]);
    ...
    public Blaze2SDK.Blaze.Redirector.IpAddress? IpAddress
    {
    ...
    public Blaze2SDK.Blaze.Redirector.XboxServerAddress? XboxServerAddress
    {
