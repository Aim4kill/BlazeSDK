...
public class FieldValidationError : Tdf
{
    ...
    private TdfEnum<Blaze3SDK.Blaze.Authentication.NucleusCause> _error = new(__typeInfos[0]);
    private TdfEnum<Blaze3SDK.Blaze.Authentication.NucleusField> _field = new(__typeInfos[1]);
    ...
    public Blaze3SDK.Blaze.Authentication.NucleusCause Error
    {
        get => _error.Value;
        set => _error.Value = value;
    }

    public Blaze3SDK.Blaze.Authentication.NucleusField Field
    {
        get => _field.Value;
