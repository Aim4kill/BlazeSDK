...
public class PersonaDetails : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("ExtId", "mExtId", 0xE3296600, TdfType.UInt64, 3, true), // XREF
        new TdfMemberInfo("ExtType", "mExtType", 0xE34E7000, TdfType.Enum, 4, true), // XTYP
    ];
    ...
    private TdfUInt64 _extId = new(__typeInfos[3]);
    private TdfEnum<Blaze2SDK.Blaze.Authentication.ExternalRefType> _extType = new(__typeInfos[4]);
    ...
    public Blaze2SDK.Blaze.Authentication.ExternalRefType ExtType
    {
        get => _extType.Value;
