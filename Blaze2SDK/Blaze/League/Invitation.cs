...
public class Invitation : Tdf
{
    ...
    private TdfStruct<Blaze2SDK.Blaze.League.LeagueUser?> _invitee = new(__typeInfos[1]);
    private TdfUInt32 _leagueId = new(__typeInfos[2]);
    private TdfStruct<Blaze2SDK.Blaze.League.LeagueUser?> _inviter = new(__typeInfos[3]);
    ...
    public Blaze2SDK.Blaze.League.LeagueUser? Invitee
    {
        get => _invitee.Value;
    ...
    public Blaze2SDK.Blaze.League.LeagueUser? Inviter
    {
        get => _inviter.Value;
