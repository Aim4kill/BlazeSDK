...
public class ClubLocalizedNews : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("ContentCreator", "mContentCreator", 0xBB78E300, TdfType.Int64, 2, true), // NWCC
        new TdfMemberInfo("Flags", "mFlags", 0xBB79AC00, TdfType.Enum, 3, true), // NWFL
        new TdfMemberInfo("NewsId", "mNewsId", 0xBB7A6400, TdfType.ObjectId, 4, true), // NWID
    ...
    private TdfInt64 _contentCreator = new(__typeInfos[2]);
    private TdfEnum<Blaze3SDK.Blaze.Clubs.ClubNewsFlags> _flags = new(__typeInfos[3]);
    private TdfObjectId _newsId = new(__typeInfos[4]);
    ...
    public Blaze3SDK.Blaze.Clubs.ClubNewsFlags Flags
    {
        get => _flags.Value;
