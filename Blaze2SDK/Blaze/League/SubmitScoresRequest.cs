...
public class SubmitScoresRequest : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("User0", "mUser0", 0xD73C9000, TdfType.UInt32, 4, true), // USR0
        new TdfMemberInfo("User1", "mUser1", 0xD73C9100, TdfType.UInt32, 5, true), // USR1
    ...
    private TdfUInt32 _user0 = new(__typeInfos[4]);
    private TdfUInt32 _user1 = new(__typeInfos[5]);
