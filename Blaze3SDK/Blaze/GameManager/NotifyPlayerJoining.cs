...
public class NotifyPlayerJoining : Tdf
{
    ...
    private TdfStruct<Blaze3SDK.Blaze.GameManager.ReplicatedGamePlayer?> _joiningPlayer = new(__typeInfos[1]);
    ...
    public Blaze3SDK.Blaze.GameManager.ReplicatedGamePlayer? JoiningPlayer
    {
