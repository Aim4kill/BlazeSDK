...
public class NewsItem : Tdf
{
    ...
    private TdfStruct<Blaze3SDK.Blaze.League.LeagueUser?> _creator = new(__typeInfos[0]);
    private TdfEnum<Blaze3SDK.Blaze.League.NewsFormat> _format = new(__typeInfos[1]);
    private TdfString _news = new(__typeInfos[2]);
    private TdfEnum<Blaze3SDK.Blaze.League.NewsMsgType> _msgType = new(__typeInfos[3]);
    private TdfUInt32 _newsId = new(__typeInfos[4]);
    private TdfList<Blaze3SDK.Blaze.League.NewsItemParam> _params = new(__typeInfos[5]);
    ...
    public Blaze3SDK.Blaze.League.NewsFormat Format
    {
        get => _format.Value;
    ...
    public Blaze3SDK.Blaze.League.NewsMsgType MsgType
    {
        get => _msgType.Value;
    ...
    public IList<Blaze3SDK.Blaze.League.NewsItemParam> Params
    {
        get => _params.Value;
