...
public class NetworkAddress : Union
{
    ...
    private TdfStruct<Blaze2SDK.Blaze.XboxClientAddress?> _xboxClientAddress = new(__typeInfos[0]);
    private TdfStruct<Blaze2SDK.Blaze.XboxServerAddress?> _xboxServerAddress = new(__typeInfos[1]);
    private TdfStruct<Blaze2SDK.Blaze.IpPairAddress?> _ipPairAddress = new(__typeInfos[2]);
    private TdfStruct<Blaze2SDK.Blaze.IpAddress?> _ipAddress = new(__typeInfos[3]);
    private TdfStruct<Blaze2SDK.Blaze.HostNameAddress?> _hostNameAddress = new(__typeInfos[4]);
    ...
    public Blaze2SDK.Blaze.XboxClientAddress? XboxClientAddress
    {
    ...
    public Blaze2SDK.Blaze.XboxServerAddress? XboxServerAddress
    {
    ...
    public Blaze2SDK.Blaze.IpPairAddress? IpPairAddress
    {
    ...
    public Blaze2SDK.Blaze.IpAddress? IpAddress
    {
    ...
    public Blaze2SDK.Blaze.HostNameAddress? HostNameAddress
    {
