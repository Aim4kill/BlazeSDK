...
public class LeaderboardStatValues : Tdf
{
    ...
    private TdfList<Blaze3SDK.Blaze.Stats.LeaderboardStatValuesRow> _rows = new(__typeInfos[0]);
    ...
    public IList<Blaze3SDK.Blaze.Stats.LeaderboardStatValuesRow> Rows
    {
        get => _rows.Value;
