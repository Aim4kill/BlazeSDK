...
public class RemovePlayerRequest : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("PlayerId", "mPlayerId", 0xC2990000, TdfType.UInt32, 3, true), // PID
    ...
    private TdfUInt32 _playerId = new(__typeInfos[3]);
    private TdfEnum<Blaze2SDK.Blaze.GameManager.PlayerRemovedReason> _playerRemovedReason = new(__typeInfos[4]);
    ...
    public Blaze2SDK.Blaze.GameManager.PlayerRemovedReason PlayerRemovedReason
    {
