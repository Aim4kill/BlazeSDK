...
public class DraftProfile : Tdf
{
    ...
    private TdfList<Blaze2SDK.Blaze.League.Player> _players = new(__typeInfos[0]);
    private TdfList<Blaze2SDK.Blaze.League.PositionPref> _roundPositionPrefs = new(__typeInfos[1]);
    ...
    public IList<Blaze2SDK.Blaze.League.PositionPref> RoundPositionPrefs
    {
