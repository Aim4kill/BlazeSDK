...
public class MemberInfo : Tdf
{
    ...
    private TdfStruct<Blaze3SDK.Blaze.League.LeagueUser?> _member = new(__typeInfos[6]);
    private TdfUInt8 _isStringMetadata = new(__typeInfos[7]);
    private TdfStruct<Blaze3SDK.Blaze.League.MemberStats?> _stats = new(__typeInfos[8]);
    ...
    public Blaze3SDK.Blaze.League.LeagueUser? Member
    {
        get => _member.Value;
    ...
    public Blaze3SDK.Blaze.League.MemberStats? Stats
    {
        get => _stats.Value;
