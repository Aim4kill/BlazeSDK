...
public class IncrementUseCountRequest : Tdf
{
    ...
    public IncrementUseCountRequest()
    {
        __members = [
            _contentCategory,
            _contentId,
    ...
    public override Tdf CreateNew() => new IncrementUseCountRequest();
    public override ITdfMember[] GetMembers() => __members;
    public override TdfMemberInfo[] GetMemberInfos() => __typeInfos;
    public static TdfMemberInfo[] GetTdfMemberInfos() => __typeInfos;
    public override string GetClassName() => "IncrementUseCountRequest";
    public override string GetFullClassName() => "Blaze::Locker::IncrementUseCountRequest";
