...
public class HostBalanceRuleStatus : Tdf
{
    ...
    private TdfEnum<Blaze2SDK.Blaze.GameManager.HostBalanceRuleStatus.HostBalanceValues> _matchedHostBalanceValue = new(__typeInfos[0]);
    ...
    public Blaze2SDK.Blaze.GameManager.HostBalanceRuleStatus.HostBalanceValues MatchedHostBalanceValue
    {
