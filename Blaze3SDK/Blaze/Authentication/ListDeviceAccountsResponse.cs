...
public class ListDeviceAccountsResponse : Tdf
{
    ...
    private TdfList<Blaze3SDK.Blaze.Authentication.UserDetails> _userList = new(__typeInfos[0]);
    ...
    public IList<Blaze3SDK.Blaze.Authentication.UserDetails> UserList
    {
        get => _userList.Value;
