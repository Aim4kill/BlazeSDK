...
public class MatchmakingAsyncStatus : Tdf
{
    ...
    private TdfStruct<Blaze2SDK.Blaze.GameManager.CreateGameStatus?> _createGameStatus = new(__typeInfos[0]);
    private TdfStruct<Blaze2SDK.Blaze.GameManager.MatchmakingCustomAsyncStatus?> _customAsynStatus = new(__typeInfos[1]);
    private TdfStruct<Blaze2SDK.Blaze.GameManager.DNFRuleStatus?> _dNFRuleStatus = new(__typeInfos[2]);
    private TdfStruct<Blaze2SDK.Blaze.GameManager.FindGameStatus?> _findGameStatus = new(__typeInfos[3]);
    private TdfStruct<Blaze2SDK.Blaze.GameManager.GeoLocationRuleStatus?> _geoLocationRuleStatus = new(__typeInfos[4]);
    private TdfMap<string, Blaze2SDK.Blaze.GameManager.GenericRuleStatus> _genericRuleStatusMap = new(__typeInfos[5]);
    private TdfStruct<Blaze2SDK.Blaze.GameManager.GameSizeRuleStatus?> _gameSizeRuleStatus = new(__typeInfos[6]);
    private TdfStruct<Blaze2SDK.Blaze.GameManager.HostBalanceRuleStatus?> _hostBalanceRuleStatus = new(__typeInfos[7]);
    private TdfStruct<Blaze2SDK.Blaze.GameManager.HostViabilityRuleStatus?> _hostViabilityRuleStatus = new(__typeInfos[8]);
    private TdfStruct<Blaze2SDK.Blaze.GameManager.PingSiteRuleStatus?> _pingSiteRuleStatus = new(__typeInfos[9]);
    private TdfStruct<Blaze2SDK.Blaze.GameManager.RankRuleStatus?> _rankRuleStatus = new(__typeInfos[10]);
    private TdfMap<string, Blaze2SDK.Blaze.GameManager.SkillRuleStatus> _skillRuleStatusMap = new(__typeInfos[11]);
    private TdfStruct<Blaze2SDK.Blaze.GameManager.TeamSizeRuleStatus?> _teamSizeRuleStatus = new(__typeInfos[12]);
    ...
    public Blaze2SDK.Blaze.GameManager.CreateGameStatus? CreateGameStatus
    {
        get => _createGameStatus.Value;
        set => _createGameStatus.Value = value;
    }

    public Blaze2SDK.Blaze.GameManager.MatchmakingCustomAsyncStatus? CustomAsynStatus
    {
        get => _customAsynStatus.Value;
        set => _customAsynStatus.Value = value;
    }

    public Blaze2SDK.Blaze.GameManager.DNFRuleStatus? DNFRuleStatus
    {
        get => _dNFRuleStatus.Value;
        set => _dNFRuleStatus.Value = value;
    }

    public Blaze2SDK.Blaze.GameManager.FindGameStatus? FindGameStatus
    {
        get => _findGameStatus.Value;
        set => _findGameStatus.Value = value;
    }

    public Blaze2SDK.Blaze.GameManager.GeoLocationRuleStatus? GeoLocationRuleStatus
    {
        get => _geoLocationRuleStatus.Value;
        set => _geoLocationRuleStatus.Value = value;
    }

    public IDictionary<string, Blaze2SDK.Blaze.GameManager.GenericRuleStatus> GenericRuleStatusMap
    {
        get => _genericRuleStatusMap.Value;
        set => _genericRuleStatusMap.Value = value;
    }

    public Blaze2SDK.Blaze.GameManager.GameSizeRuleStatus? GameSizeRuleStatus
    {
        get => _gameSizeRuleStatus.Value;
        set => _gameSizeRuleStatus.Value = value;
    }

    public Blaze2SDK.Blaze.GameManager.HostBalanceRuleStatus? HostBalanceRuleStatus
    {
        get => _hostBalanceRuleStatus.Value;
        set => _hostBalanceRuleStatus.Value = value;
    }

    public Blaze2SDK.Blaze.GameManager.HostViabilityRuleStatus? HostViabilityRuleStatus
    {
        get => _hostViabilityRuleStatus.Value;
        set => _hostViabilityRuleStatus.Value = value;
    }

    public Blaze2SDK.Blaze.GameManager.PingSiteRuleStatus? PingSiteRuleStatus
    {
        get => _pingSiteRuleStatus.Value;
        set => _pingSiteRuleStatus.Value = value;
    }

    public Blaze2SDK.Blaze.GameManager.RankRuleStatus? RankRuleStatus
    {
        get => _rankRuleStatus.Value;
        set => _rankRuleStatus.Value = value;
    }

    public IDictionary<string, Blaze2SDK.Blaze.GameManager.SkillRuleStatus> SkillRuleStatusMap
    {
        get => _skillRuleStatusMap.Value;
        set => _skillRuleStatusMap.Value = value;
    }

    public Blaze2SDK.Blaze.GameManager.TeamSizeRuleStatus? TeamSizeRuleStatus
    {
