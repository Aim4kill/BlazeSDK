...
public class PersonaInfo : Tdf
{
    ...
    private TdfEnum<Blaze2SDK.Blaze.Authentication.PersonaStatus> _status = new(__typeInfos[5]);
    private TdfEnum<Blaze2SDK.Blaze.Authentication.StatusReason> _statusReasonCode = new(__typeInfos[6]);
    ...
    public Blaze2SDK.Blaze.Authentication.PersonaStatus Status
    {
        get => _status.Value;
        set => _status.Value = value;
    }

    public Blaze2SDK.Blaze.Authentication.StatusReason StatusReasonCode
    {
