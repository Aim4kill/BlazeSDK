...
public class CreateAccountParameters : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("ParentalEmail", "mParentalEmail", 0xC32BB400, TdfType.String, 12, true), // PRNT
        new TdfMemberInfo("UserProfileInfo", "mUserProfileInfo", 0xC32BE600, TdfType.Struct, 13, true), // PROF
        new TdfMemberInfo("TosVersion", "mTosVersion", 0xD2FCF600, TdfType.String, 14, true), // TOSV
    ];
    ...
    private TdfString _parentalEmail = new(__typeInfos[12]);
    private TdfStruct<Blaze2SDK.Blaze.Authentication.UserProfileInfo?> _userProfileInfo = new(__typeInfos[13]);
    private TdfString _tosVersion = new(__typeInfos[14]);
    ...
    public Blaze2SDK.Blaze.Authentication.UserProfileInfo? UserProfileInfo
    {
