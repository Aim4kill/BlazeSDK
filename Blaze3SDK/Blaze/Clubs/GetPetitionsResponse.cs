...
public class GetPetitionsResponse : Tdf
{
    ...
    private TdfList<Blaze3SDK.Blaze.Clubs.ClubMessage> _clubPetitionsList = new(__typeInfos[0]);
    ...
    public IList<Blaze3SDK.Blaze.Clubs.ClubMessage> ClubPetitionsList
    {
