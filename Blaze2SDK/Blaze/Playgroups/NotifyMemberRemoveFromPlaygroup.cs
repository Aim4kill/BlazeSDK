...
public class NotifyMemberRemoveFromPlaygroup : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        new TdfMemberInfo("BlazeId", "mBlazeId", 0xB6CCF400, TdfType.UInt32, 0, true), // MLST
    ...
    private TdfEnum<Blaze2SDK.Blaze.Playgroups.PlaygroupMemberRemoveReason> _reason = new(__typeInfos[2]);
    ...
    public Blaze2SDK.Blaze.Playgroups.PlaygroupMemberRemoveReason Reason
    {
        get => _reason.Value;
