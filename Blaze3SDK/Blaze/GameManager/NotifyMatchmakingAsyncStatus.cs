...
public class NotifyMatchmakingAsyncStatus : Tdf
{
    ...
    private TdfList<Blaze3SDK.Blaze.GameManager.MatchmakingAsyncStatus> _matchmakingAsyncStatusList = new(__typeInfos[0]);
    ...
    public IList<Blaze3SDK.Blaze.GameManager.MatchmakingAsyncStatus> MatchmakingAsyncStatusList
    {
