...
public class MemberOnlineStatusClass : Tdf
{
    ...
    private TdfEnum<Blaze2SDK.Blaze.Clubs.MemberOnlineStatus> _memberOnlineStatus = new(__typeInfos[0]);
    ...
    public Blaze2SDK.Blaze.Clubs.MemberOnlineStatus MemberOnlineStatus
    {
