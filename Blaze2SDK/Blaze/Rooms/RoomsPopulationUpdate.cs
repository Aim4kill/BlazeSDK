...
public class RoomsPopulationUpdate : Tdf
{
    ...
    private TdfMap<uint, Blaze2SDK.Blaze.Rooms.RoomsPopulationUpdate.RoomAttributes> _populationAttributes = new(__typeInfos[0]);
    ...
    public IDictionary<uint, Blaze2SDK.Blaze.Rooms.RoomsPopulationUpdate.RoomAttributes> PopulationAttributes
    {
