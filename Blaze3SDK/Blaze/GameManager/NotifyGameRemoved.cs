...
public class NotifyGameRemoved : Tdf
{
    ...
    private TdfEnum<Blaze3SDK.Blaze.GameManager.GameDestructionReason> _destructionReason = new(__typeInfos[1]);
    ...
    public Blaze3SDK.Blaze.GameManager.GameDestructionReason DestructionReason
    {
