...
public class NotifyHostMigrationStart : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("NewHostId", "mNewHostId", 0xA2FCF400, TdfType.Int64, 1, true), // HOST
    ...
    private TdfInt64 _newHostId = new(__typeInfos[1]);
    private TdfEnum<Blaze3SDK.Blaze.GameManager.HostMigrationType> _migrationType = new(__typeInfos[2]);
    ...
    public Blaze3SDK.Blaze.GameManager.HostMigrationType MigrationType
    {
