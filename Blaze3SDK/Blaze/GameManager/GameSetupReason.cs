...
namespace Blaze3SDK.Blaze.GameManager
{
    ...
    {
        /*
          Blaze::GameManager::DatalessSetupContext *mDatalessSetupContext;
          Blaze::GameManager::ResetDedicatedServerSetupContext *mResetDedicatedServerSetupContext;
          Blaze::GameManager::IndirectJoinGameSetupContext *mIndirectJoinGameSetupContext;
          Blaze::GameManager::MatchmakingSetupContext *mMatchmakingSetupContext;
          Blaze::GameManager::IndirectMatchmakingSetupContext *mIndirectMatchmakingSetupContext;
