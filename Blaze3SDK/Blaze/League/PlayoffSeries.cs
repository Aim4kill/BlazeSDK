...
public class PlayoffSeries : Tdf
{
    ...
    private TdfStruct<Blaze3SDK.Blaze.League.LeagueUser?> _player1 = new(__typeInfos[4]);
    private TdfUInt32 _player1TeamId = new(__typeInfos[5]);
    private TdfUInt8 _player2FinalScore = new(__typeInfos[6]);
    private TdfStruct<Blaze3SDK.Blaze.League.LeagueUser?> _player2 = new(__typeInfos[7]);
    private TdfUInt32 _player2TeamId = new(__typeInfos[8]);
    private TdfUInt8 _gamesPlayed = new(__typeInfos[9]);
    private TdfEnum<Blaze3SDK.Blaze.League.PlayoffType> _playoffType = new(__typeInfos[10]);
    private TdfUInt8 _round = new(__typeInfos[11]);
    private TdfList<Blaze3SDK.Blaze.League.PlayoffGameScore> _gameScores = new(__typeInfos[12]);
    ...
    public Blaze3SDK.Blaze.League.LeagueUser? Player1
    {
        get => _player1.Value;
    ...
    public Blaze3SDK.Blaze.League.LeagueUser? Player2
    {
        get => _player2.Value;
    ...
    public IList<Blaze3SDK.Blaze.League.PlayoffGameScore> GameScores
    {
