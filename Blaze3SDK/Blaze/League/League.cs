...
public class League : Tdf
{
    ...
    private TdfStruct<Blaze3SDK.Blaze.League.LeagueUser?> _currChampion = new(__typeInfos[2]);
    private TdfStruct<Blaze3SDK.Blaze.League.LeagueUser?> _creator = new(__typeInfos[3]);
    ...
    private TdfEnum<Blaze3SDK.Blaze.League.LeagueFlags> _leagueFlags = new(__typeInfos[11]);
    ...
    private TdfList<int> _options = new(__typeInfos[18]);
    private TdfString _password = new(__typeInfos[19]);
    private TdfUInt8 _numPlayoffGames = new(__typeInfos[20]);
    private TdfEnum<Blaze3SDK.Blaze.League.PlayoffType> _playoffType = new(__typeInfos[21]);
    ...
    private TdfEnum<Blaze3SDK.Blaze.League.ScheduleType> _scheduleType = new(__typeInfos[25]);
    ...
    private TdfEnum<Blaze3SDK.Blaze.League.LeagueState> _leagueState = new(__typeInfos[29]);
    private TdfList<uint> _teamsInUse = new(__typeInfos[30]);
    private TdfUInt32 _trophy = new(__typeInfos[31]);
    private TdfEnum<Blaze3SDK.Blaze.League.TradeType> _tradeType = new(__typeInfos[32]);
    ...
    public Blaze3SDK.Blaze.League.LeagueUser? CurrChampion
    {
        get => _currChampion.Value;
        set => _currChampion.Value = value;
    }

    public Blaze3SDK.Blaze.League.LeagueUser? Creator
    {
        get => _creator.Value;
    ...
    public Blaze3SDK.Blaze.League.LeagueState LeagueState
    {
