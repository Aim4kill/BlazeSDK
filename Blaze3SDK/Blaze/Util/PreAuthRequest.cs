...
public class PreAuthRequest : Tdf
{
    ...
    private TdfStruct<Blaze3SDK.Blaze.Util.ClientData?> _clientData = new(__typeInfos[0]);
    private TdfStruct<Blaze3SDK.Blaze.ClientInfo?> _clientInfo = new(__typeInfos[1]);
    private TdfStruct<Blaze3SDK.Blaze.Util.FetchClientConfigRequest?> _fetchClientConfig = new(__typeInfos[2]);
    ...
    public Blaze3SDK.Blaze.Util.ClientData? ClientData
    {
        get => _clientData.Value;
        set => _clientData.Value = value;
    }

    public Blaze3SDK.Blaze.ClientInfo? ClientInfo
    {
        get => _clientInfo.Value;
        set => _clientInfo.Value = value;
    }

    public Blaze3SDK.Blaze.Util.FetchClientConfigRequest? FetchClientConfig
    {
