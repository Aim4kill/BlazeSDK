...
public class NotifyDestroyPlaygroup : Tdf
{
    ...
    private TdfEnum<Blaze3SDK.Blaze.Playgroups.PlaygroupDestroyReason> _reason = new(__typeInfos[1]);
    ...
    public Blaze3SDK.Blaze.Playgroups.PlaygroupDestroyReason Reason
    {
        get => _reason.Value;
