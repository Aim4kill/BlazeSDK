...
public class GetTrophiesResponse : Tdf
{
    ...
    private TdfList<Blaze2SDK.Blaze.Tournaments.TournamentTrophyData> _trophies = new(__typeInfos[0]);
    ...
    public IList<Blaze2SDK.Blaze.Tournaments.TournamentTrophyData> Trophies
    {
        get => _trophies.Value;
