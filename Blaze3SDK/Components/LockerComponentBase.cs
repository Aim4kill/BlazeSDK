...
namespace Blaze3SDK.Components
{
    public static class LockerComponentBase
    {
        ...
        public class Server : BlazeComponent<LockerComponentCommand, LockerComponentNotification, Blaze3RpcError>
        {
        ...
        public class Client : BlazeComponent<LockerComponentCommand, LockerComponentNotification, Blaze3RpcError>
        {
