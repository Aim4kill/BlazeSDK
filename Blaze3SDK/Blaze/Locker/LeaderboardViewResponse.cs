...
public class LeaderboardViewResponse : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("ContextType", "mContextType", 0x8F4E7000, TdfType.ObjectType, 1, true), // CTYP
    ...
    private TdfObjectType _contextType = new(__typeInfos[1]);
    private TdfString _desc = new(__typeInfos[2]);
    private TdfObjectType _entityType = new(__typeInfos[3]);
    private TdfEnum<Blaze3SDK.Blaze.Locker.LeaderboardType> _leaderboardType = new(__typeInfos[4]);
    private TdfList<Blaze3SDK.Blaze.Locker.LeaderboardViewColumn> _viewColumns = new(__typeInfos[5]);
    ...
    public IList<Blaze3SDK.Blaze.Locker.LeaderboardViewColumn> ViewColumns
    {
