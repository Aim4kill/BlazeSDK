...
public class NotifyCreateDynamicDedicatedServerGame : Tdf
{
    ...
    private TdfStruct<Blaze3SDK.Blaze.GameManager.CreateGameRequest?> _createGameRequest = new(__typeInfos[0]);
    ...
    public Blaze3SDK.Blaze.GameManager.CreateGameRequest? CreateGameRequest
    {
