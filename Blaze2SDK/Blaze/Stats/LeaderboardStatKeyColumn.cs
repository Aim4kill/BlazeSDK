...
public class LeaderboardStatKeyColumn : Tdf
{
    ...
    public LeaderboardStatKeyColumn()
    {
        __members = [
            _format,
            _kind,
    ...
    public override Tdf CreateNew() => new LeaderboardStatKeyColumn();
    public override ITdfMember[] GetMembers() => __members;
    public override TdfMemberInfo[] GetMemberInfos() => __typeInfos;
    public static TdfMemberInfo[] GetTdfMemberInfos() => __typeInfos;
    public override string GetClassName() => "LeaderboardStatKeyColumn";
    public override string GetFullClassName() => "Blaze::Stats::LeaderboardStatKeyColumn";
