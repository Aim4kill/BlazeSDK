...
public class GetCategoriesResponse : Tdf
{
    ...
    private TdfMap<string, Blaze3SDK.Blaze.CommerceInfo.Category> _categoryMap = new(__typeInfos[0]);
    ...
    public IDictionary<string, Blaze3SDK.Blaze.CommerceInfo.Category> CategoryMap
    {
