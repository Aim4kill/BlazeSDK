...
public class ScheduledCategorySpecs : Tdf
{
    ...
    private TdfMap<uint, Blaze3SDK.Blaze.Rooms.ScheduledCategorySpec> _specMap = new(__typeInfos[0]);
    ...
    public IDictionary<uint, Blaze3SDK.Blaze.Rooms.ScheduledCategorySpec> SpecMap
    {
        get => _specMap.Value;
