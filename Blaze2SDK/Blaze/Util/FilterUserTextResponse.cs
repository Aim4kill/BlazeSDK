...
public class FilterUserTextResponse : Tdf
{
    ...
    private TdfList<Blaze2SDK.Blaze.Util.FilteredUserText> _filteredTextList = new(__typeInfos[0]);
    ...
    public IList<Blaze2SDK.Blaze.Util.FilteredUserText> FilteredTextList
    {
