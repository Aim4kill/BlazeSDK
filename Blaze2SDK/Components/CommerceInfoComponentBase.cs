...
public static class CommerceInfoComponentBase
{
    ...
    public class Server : BlazeComponent {
        ...
        public Server()
        {
            ...
            RegisterCommand(new RpcCommandFunc<EmptyMessage, EmptyMessage, EmptyMessage>()
            {
                Id = (ushort)CommerceInfoComponentCommand.refreshOfbCache,
                Name = "refreshOfbCache",
                IsSupported = IsCommandSupported(CommerceInfoComponentCommand.refreshOfbCache),
                Func = async (req, ctx) => await RefreshOfbCacheAsync(req, ctx).ConfigureAwait(false)
            });
        ...
        /// <summary>
        /// This method is called when server receives a <b>CommerceInfoComponent::refreshOfbCache</b> command.<br/>
        /// Request type: <see cref="EmptyMessage"/><br/>
        /// Response type: <see cref="EmptyMessage"/><br/>
        /// </summary>
        public virtual Task<EmptyMessage> RefreshOfbCacheAsync(EmptyMessage request, BlazeRpcContext context)
        {
            throw new CommerceInfoException(ServerError.ERR_COMMAND_NOT_FOUND);
        }
