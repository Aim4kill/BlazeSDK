...
public class GetContentTopNRequest : Tdf
{
    ...
    private TdfList<Blaze2SDK.Blaze.Locker.LeaderboardFilter> _filters = new(__typeInfos[2]);
    private TdfEnum<Blaze2SDK.Blaze.Locker.LeaderboardType> _leaderboardType = new(__typeInfos[3]);
    ...
    public IList<Blaze2SDK.Blaze.Locker.LeaderboardFilter> Filters
    {
        get => _filters.Value;
