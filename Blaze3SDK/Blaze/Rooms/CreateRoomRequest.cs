...
public class CreateRoomRequest : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("Capacity", "mCapacity", 0xCA387000, TdfType.Int32, 4, true), // RCAP
        new TdfMemberInfo("Name", "mName", 0xCAE86D00, TdfType.String, 5, true), // RNAM
    ];
    ...
    private TdfInt32 _capacity = new(__typeInfos[4]);
