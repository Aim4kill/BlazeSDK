...
public class RoomReplicationContext : Tdf
{
    ...
    private TdfEnum<Blaze2SDK.Blaze.Rooms.RoomReplicationContext.RoomUpdateReason> _updateReason = new(__typeInfos[1]);
    ...
    public Blaze2SDK.Blaze.Rooms.RoomReplicationContext.RoomUpdateReason UpdateReason
    {
