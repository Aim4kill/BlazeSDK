...
public class LeaderboardFolderGroup : Tdf
{
    ...
    private TdfList<Blaze2SDK.Blaze.Stats.FolderDescriptor> _folderDescriptors = new(__typeInfos[0]);
    ...
    public IList<Blaze2SDK.Blaze.Stats.FolderDescriptor> FolderDescriptors
    {
