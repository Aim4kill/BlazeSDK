...
public class GameReport : Tdf
{
    public class Report : Tdf
    {
        ...
        public override string GetFullClassName() => "Blaze::GameReporting::GameReport::Report";
    ...
    public class ReportType : Tdf
    {
        ...
        private TdfMap<uint, Blaze2SDK.Blaze.GameReporting.GameReport.Report> _reportMap = new(__typeInfos[0]);
        ...
        public override string GetFullClassName() => "Blaze::GameReporting::GameReport::ReportType";
    
        public IDictionary<uint, Blaze2SDK.Blaze.GameReporting.GameReport.Report> ReportMap
        {
    ...
    private TdfMap<uint, Blaze2SDK.Blaze.GameReporting.GameReport.Report> _playerReportMap = new(__typeInfos[5]);
    private TdfMap<string, Blaze2SDK.Blaze.GameReporting.GameReport.ReportType> _reportTypeMap = new(__typeInfos[6]);
    ...
    public IDictionary<uint, Blaze2SDK.Blaze.GameReporting.GameReport.Report> PlayerReportMap
    {
        get => _playerReportMap.Value;
        set => _playerReportMap.Value = value;
    }

    public IDictionary<string, Blaze2SDK.Blaze.GameReporting.GameReport.ReportType> ReportTypeMap
    {
