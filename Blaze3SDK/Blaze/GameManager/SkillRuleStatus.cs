...
public class SkillRuleStatus : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("MinSkillAccepted", "mMinSkillAccepted", 0xCEBB6E00, TdfType.Int64, 1, true), // SKMN
        new TdfMemberInfo("MaxSkillAccepted", "mMaxSkillAccepted", 0xCEBB7800, TdfType.Int64, 2, true), // SKMX
    ];
    private ITdfMember[] __members;

    private TdfString _ruleName = new(__typeInfos[0]);
    private TdfInt64 _minSkillAccepted = new(__typeInfos[1]);
    private TdfInt64 _maxSkillAccepted = new(__typeInfos[2]);
