...
namespace ProtoFire.Tls.Crypto;
    ...
    : TlsCipher
{
    ...
    public Rc4Cipher(TlsCryptoParameters cryptoParams, int cipherKeySize, TlsHmac clientMac, TlsHmac serverMac)
    {
        ...
        int offset, int len)
    {
        ...
        bool badMac = !Org.BouncyCastle.Tls.TlsUtilities.ConstantTimeAreEqual(macSize, expectedMac, 0, plaintext, macInputLen);
        if (badMac)
