...
public class PlaygroupMemberInfo : Tdf
{
    ...
    private TdfEnum<Blaze2SDK.Blaze.Playgroups.MemberPermissions> _permissions = new(__typeInfos[2]);
    private TdfUnion<Blaze2SDK.Blaze.NetworkAddress> _networkAddress = new(__typeInfos[3]);
    private TdfUInt8 _slotId = new(__typeInfos[4]);
    private TdfStruct<Blaze2SDK.Blaze.UserIdentification?> _user = new(__typeInfos[5]);
