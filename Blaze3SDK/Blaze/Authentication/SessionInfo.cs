...
public class SessionInfo : Tdf
{
    ...
    private TdfInt64 _blazeUserId = new(__typeInfos[0]);
    ...
    private TdfStruct<Blaze3SDK.Blaze.Authentication.PersonaDetails?> _personaDetails = new(__typeInfos[5]);
    ...
    public Blaze3SDK.Blaze.Authentication.PersonaDetails? PersonaDetails
    {
