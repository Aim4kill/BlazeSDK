...
public class KickPlaygroupMemberRequest : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        new TdfMemberInfo("BlazeId", "mBlazeId", 0x96990000, TdfType.UInt32, 0, true), // EID
    ...
    private TdfEnum<Blaze2SDK.Blaze.Playgroups.PlaygroupMemberRemoveReason> _kickedReason = new(__typeInfos[2]);
    ...
    public Blaze2SDK.Blaze.Playgroups.PlaygroupMemberRemoveReason KickedReason
    {
