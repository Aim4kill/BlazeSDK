...
public class GetContentTopNResponse : Tdf
{
    ...
    private TdfList<Blaze2SDK.Blaze.Locker.LeaderboardValuesRow> _topNList = new(__typeInfos[0]);
    ...
    public IList<Blaze2SDK.Blaze.Locker.LeaderboardValuesRow> TopNList
    {
        get => _topNList.Value;
