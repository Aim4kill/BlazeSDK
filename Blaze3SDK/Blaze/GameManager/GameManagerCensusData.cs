...
public class GameManagerCensusData : Tdf
{
    ...
    private TdfList<Blaze3SDK.Blaze.GameManager.GameAttributeCensusData> _gameAttributesData = new(__typeInfos[1]);
    ...
    public IList<Blaze3SDK.Blaze.GameManager.GameAttributeCensusData> GameAttributesData
    {
