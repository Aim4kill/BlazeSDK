...
public class SkillRulePrefs : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        new TdfMemberInfo("SkillValueOverride", "mSkillValueOverride", 0xCEB93300, TdfType.Int32, 0, true), // SKDS
    ...
    private TdfInt32 _skillValueOverride = new(__typeInfos[0]);
    private TdfString _ruleName = new(__typeInfos[1]);
    private TdfEnum<Blaze2SDK.Blaze.GameManager.SkillValueOverride> _useSkillValueOverride = new(__typeInfos[2]);
    ...
    public Blaze2SDK.Blaze.GameManager.SkillValueOverride UseSkillValueOverride
    {
