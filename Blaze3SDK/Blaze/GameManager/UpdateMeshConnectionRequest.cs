...
public class UpdateMeshConnectionRequest : Tdf
{
    ...
    private TdfList<Blaze3SDK.Blaze.GameManager.PlayerConnectionStatus> _meshConnectionStatusList = new(__typeInfos[1]);
    ...
    public IList<Blaze3SDK.Blaze.GameManager.PlayerConnectionStatus> MeshConnectionStatusList
    {
