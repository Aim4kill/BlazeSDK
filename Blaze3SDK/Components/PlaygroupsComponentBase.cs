...
public static class PlaygroupsComponentBase
{
    ...
    public enum Error : ushort {
        ...
        PLAYGROUPS_ERR_ALREADY_IN_GROUP = 9,
    }
    ...
    public class Server : BlazeComponent {
        ...
        public Server()
        {
            ...
            RegisterCommand(new RpcCommandFunc<EmptyMessage, EmptyMessage, EmptyMessage>()
            {
                Id = (ushort)PlaygroupsComponentCommand.resetPlaygroupSession,
                Name = "resetPlaygroupSession",
                IsSupported = IsCommandSupported(PlaygroupsComponentCommand.resetPlaygroupSession),
                Func = async (req, ctx) => await ResetPlaygroupSessionAsync(req, ctx).ConfigureAwait(false)
            });
        ...
        /// <summary>
        /// This method is called when server receives a <b>PlaygroupsComponent::resetPlaygroupSession</b> command.<br/>
        /// Request type: <see cref="EmptyMessage"/><br/>
        /// Response type: <see cref="EmptyMessage"/><br/>
        /// </summary>
        public virtual Task<EmptyMessage> ResetPlaygroupSessionAsync(EmptyMessage request, BlazeRpcContext context)
        {
            throw new PlaygroupsException(ServerError.ERR_COMMAND_NOT_FOUND);
        }
        ...
        /// <summary>
        /// Call this method when you want to send to client a <b>PlaygroupsComponent::NotifyXboxSessionChange</b> notification.<br/>
        /// Notification type: <see cref="NotifyXboxSessionInfo"/><br/>
        /// </summary>
        public static Task NotifyNotifyXboxSessionChangeAsync(BlazeRpcConnection connection, NotifyXboxSessionInfo notification, bool sendNow = false)
        {
            Action<BlazePacket> configurer = (packet) =>
            {
                ProtoFire.Frames.IFireFrame frame = packet.Frame;
                frame.Component = PlaygroupsComponentBase.Id;
                frame.Command = (ushort)PlaygroupsComponentNotification.NotifyXboxSessionChange;
                frame.MessageType = ProtoFire.Frames.MessageType.Notification;
                packet.Data = notification;
            };
