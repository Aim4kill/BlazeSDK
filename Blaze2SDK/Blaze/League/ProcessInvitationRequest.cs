...
public class ProcessInvitationRequest : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        new TdfMemberInfo("InviterId", "mInviterId", 0xA6EDB200, TdfType.UInt32, 0, true), // INVR
        new TdfMemberInfo("InviteeId", "mInviteeId", 0xA6EDB400, TdfType.UInt32, 1, true), // INVT
    ...
    private TdfUInt32 _inviterId = new(__typeInfos[0]);
    private TdfUInt32 _inviteeId = new(__typeInfos[1]);
    private TdfUInt32 _leagueId = new(__typeInfos[2]);
    private TdfEnum<Blaze2SDK.Blaze.League.InvitationOp> _operation = new(__typeInfos[3]);
    ...
    public Blaze2SDK.Blaze.League.InvitationOp Operation
    {
