...
public class ClubInfo : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("LastGameResult", "mLastGameResult", 0xB339F200, TdfType.String, 5, true), // LSGR
        new TdfMemberInfo("LastOppo", "mLastOppo", 0xB33BF000, TdfType.UInt32, 6, true), // LSOP
        new TdfMemberInfo("MemberOnlineStatusCounts", "mMemberOnlineStatusCounts", 0xB738EF00, TdfType.Map, 7, true), // MSCO
        new TdfMemberInfo("LastOppoName", "mLastOppoName", 0xBF0BAD00, TdfType.String, 8, true), // OPNM
        new TdfMemberInfo("RivalCount", "mRivalCount", 0xCB68EE00, TdfType.UInt32, 9, true), // RVCN
    ];
    ...
    private TdfString _lastGameResult = new(__typeInfos[5]);
    private TdfUInt32 _lastOppo = new(__typeInfos[6]);
    private TdfMap<Blaze2SDK.Blaze.Clubs.MemberOnlineStatus, ushort> _memberOnlineStatusCounts = new(__typeInfos[7]);
    private TdfString _lastOppoName = new(__typeInfos[8]);
    private TdfUInt32 _rivalCount = new(__typeInfos[9]);
