...
public class GetTournamentsResponse : Tdf
{
    ...
    private TdfList<Blaze3SDK.Blaze.Tournaments.TournamentData> _tournaments = new(__typeInfos[0]);
    ...
    public IList<Blaze3SDK.Blaze.Tournaments.TournamentData> Tournaments
    {
