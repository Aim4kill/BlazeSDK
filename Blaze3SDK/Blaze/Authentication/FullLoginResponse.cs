...
public class FullLoginResponse : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("PCLoginToken", "mPCLoginToken", 0xC23D2B00, TdfType.String, 3, true), // PCTK
        new TdfMemberInfo("PrivacyPolicyUri", "mPrivacyPolicyUri", 0xC32A7600, TdfType.String, 4, true), // PRIV
        new TdfMemberInfo("SessionInfo", "mSessionInfo", 0xCE5CF300, TdfType.Struct, 5, true), // SESS
    ...
    private TdfString _pCLoginToken = new(__typeInfos[3]);
    private TdfString _privacyPolicyUri = new(__typeInfos[4]);
    private TdfStruct<Blaze3SDK.Blaze.Authentication.SessionInfo?> _sessionInfo = new(__typeInfos[5]);
