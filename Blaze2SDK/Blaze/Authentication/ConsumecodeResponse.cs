...
public class ConsumecodeResponse : Tdf
{
    ...
    private TdfEnum<Blaze2SDK.Blaze.Authentication.KeymasterCodeStatus> _status = new(__typeInfos[7]);
    ...
    public Blaze2SDK.Blaze.Authentication.KeymasterCodeStatus Status
    {
        get => _status.Value;
