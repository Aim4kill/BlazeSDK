...
public class PredefinedPingSiteRuleConfig : Tdf
{
    ...
    private TdfStruct<Blaze2SDK.Blaze.GameManager.PredefinedRuleConfig?> _predefinedRuleConfig = new(__typeInfos[0]);
    ...
    public Blaze2SDK.Blaze.GameManager.PredefinedRuleConfig? PredefinedRuleConfig
    {
