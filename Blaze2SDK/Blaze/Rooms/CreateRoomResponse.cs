...
public class CreateRoomResponse : Tdf
{
    ...
    private TdfStruct<Blaze2SDK.Blaze.Rooms.RoomMemberData?> _memberData = new(__typeInfos[1]);
    private TdfStruct<Blaze2SDK.Blaze.Rooms.RoomData?> _roomData = new(__typeInfos[2]);
    private TdfStruct<Blaze2SDK.Blaze.Rooms.RoomViewData?> _viewData = new(__typeInfos[3]);
    ...
    public Blaze2SDK.Blaze.Rooms.RoomMemberData? MemberData
    {
        get => _memberData.Value;
        set => _memberData.Value = value;
    }

    public Blaze2SDK.Blaze.Rooms.RoomData? RoomData
    {
        get => _roomData.Value;
        set => _roomData.Value = value;
    }

    public Blaze2SDK.Blaze.Rooms.RoomViewData? ViewData
    {
        get => _viewData.Value;
