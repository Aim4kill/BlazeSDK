...
public class KeyScopes : Tdf
{
    ...
    private TdfMap<string, Blaze3SDK.Blaze.Stats.KeyScopeItem> _keyScopesMap = new(__typeInfos[0]);
    ...
    public IDictionary<string, Blaze3SDK.Blaze.Stats.KeyScopeItem> KeyScopesMap
    {
