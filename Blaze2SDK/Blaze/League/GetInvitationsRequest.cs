...
public class GetInvitationsRequest : Tdf
{
    ...
    private TdfEnum<Blaze2SDK.Blaze.League.InvitationsToGetType> _invitationsToGet = new(__typeInfos[0]);
    ...
    public Blaze2SDK.Blaze.League.InvitationsToGetType InvitationsToGet
    {
