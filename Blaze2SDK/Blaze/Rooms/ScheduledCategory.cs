...
public class ScheduledCategory : Tdf
{
    ...
    private TdfStruct<Blaze2SDK.Blaze.Rooms.ScheduledCategorySpec?> _scheduledSpec = new(__typeInfos[0]);
    ...
    public Blaze2SDK.Blaze.Rooms.ScheduledCategorySpec? ScheduledSpec
    {
