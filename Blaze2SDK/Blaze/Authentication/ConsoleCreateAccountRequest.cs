...
public class ConsoleCreateAccountRequest : Tdf
{
    ...
    private TdfStruct<Blaze2SDK.Blaze.Authentication.CreateAccountParameters?> _createAccountParameters = new(__typeInfos[0]);
    ...
    public Blaze2SDK.Blaze.Authentication.CreateAccountParameters? CreateAccountParameters
    {
