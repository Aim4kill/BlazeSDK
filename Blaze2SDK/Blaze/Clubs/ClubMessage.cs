...
public class ClubMessage : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("ReceiverId", "mReceiverId", 0xCA58F600, TdfType.UInt32, 4, true), // RECV
        new TdfMemberInfo("ReceiverPersona", "mReceiverPersona", 0xCB0CB300, TdfType.String, 5, true), // RPRS
        new TdfMemberInfo("SenderId", "mSenderId", 0xCE5BA400, TdfType.UInt32, 6, true), // SEND
    ...
    private TdfEnum<Blaze2SDK.Blaze.Clubs.MessageType> _messageType = new(__typeInfos[3]);
    private TdfUInt32 _receiverId = new(__typeInfos[4]);
    private TdfString _receiverPersona = new(__typeInfos[5]);
    private TdfUInt32 _senderId = new(__typeInfos[6]);
    ...
    public Blaze2SDK.Blaze.Clubs.MessageType MessageType
    {
