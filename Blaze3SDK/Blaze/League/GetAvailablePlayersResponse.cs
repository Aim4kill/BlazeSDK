...
public class GetAvailablePlayersResponse : Tdf
{
    ...
    private TdfMap<uint, Blaze3SDK.Blaze.League.AvailablePlayer> _players = new(__typeInfos[0]);
    ...
    public IDictionary<uint, Blaze3SDK.Blaze.League.AvailablePlayer> Players
    {
        get => _players.Value;
