...
public class Entitlements : Tdf
{
    ...
    private TdfList<Blaze2SDK.Blaze.Authentication.Entitlement> _entitlements = new(__typeInfos[0]);
    ...
    public IList<Blaze2SDK.Blaze.Authentication.Entitlement> mEntitlements
    {
