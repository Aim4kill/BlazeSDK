...
public class Trade : Tdf
{
    ...
    private TdfStruct<Blaze3SDK.Blaze.League.LeagueUser?> _originator = new(__typeInfos[1]);
    private TdfUInt32 _originatorPlayerId = new(__typeInfos[2]);
    private TdfUInt32 _recipientPlayerId = new(__typeInfos[3]);
    private TdfStruct<Blaze3SDK.Blaze.League.LeagueUser?> _recipient = new(__typeInfos[4]);
    ...
    public Blaze3SDK.Blaze.League.LeagueUser? Originator
    {
    ...
    public Blaze3SDK.Blaze.League.LeagueUser? Recipient
    {
