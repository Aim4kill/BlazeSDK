...
public class JoinRoomResponse : Tdf
{
    ...
    private TdfStruct<Blaze2SDK.Blaze.Rooms.RoomMemberData?> _memberData = new(__typeInfos[2]);
    private TdfStruct<Blaze2SDK.Blaze.Rooms.RoomData?> _roomData = new(__typeInfos[3]);
    private TdfStruct<Blaze2SDK.Blaze.Rooms.RoomViewData?> _viewData = new(__typeInfos[4]);
