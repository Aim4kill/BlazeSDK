...
public class SetMemberAttributesRequest : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("BlazeId", "mBlazeId", 0x96990000, TdfType.UInt32, 1, true), // EID
    ...
    public override string GetFullClassName() => "Blaze::Playgroups::SetMemberAttributesRequest";
