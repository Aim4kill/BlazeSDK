...
public class GetMyTournamentDetailsResponse : Tdf
{
    ...
    private TdfList<Blaze3SDK.Blaze.Tournaments.TournamentNode> _tournamentTree = new(__typeInfos[5]);
    ...
    public IList<Blaze3SDK.Blaze.Tournaments.TournamentNode> TournamentTree
    {
