...
public static class UtilComponentBase
{
    ...
    public enum Error : ushort {
        ...
        UTIL_PSS_NO_SERVERS_AVAILABLE = 145,
    ...
    public class Server : BlazeComponent {
        ...
        public Server()
        {
            ...
            {
                Id = (ushort)UtilComponentCommand.deleteUserSettings,
                Name = "deleteUserSettings",
                IsSupported = IsCommandSupported(UtilComponentCommand.deleteUserSettings),
            ...
            RegisterCommand(new RpcCommandFunc<EmptyMessage, PssConfig, EmptyMessage>()
            {
                Id = (ushort)UtilComponentCommand.getPssConfig,
                Name = "getPssConfig",
                IsSupported = IsCommandSupported(UtilComponentCommand.getPssConfig),
                Func = async (req, ctx) => await GetPssConfigAsync(req, ctx).ConfigureAwait(false)
            });
            
            RegisterCommand(new RpcCommandFunc<GetUserOptionsRequest, UserOptions, EmptyMessage>()
            {
                Id = (ushort)UtilComponentCommand.getUserOptions,
                Name = "getUserOptions",
                IsSupported = IsCommandSupported(UtilComponentCommand.getUserOptions),
            ...
            {
                Id = (ushort)UtilComponentCommand.setUserOptions,
                Name = "setUserOptions",
                IsSupported = IsCommandSupported(UtilComponentCommand.setUserOptions),
            ...
            {
                Id = (ushort)UtilComponentCommand.suspendUserPing,
                Name = "suspendUserPing",
                IsSupported = IsCommandSupported(UtilComponentCommand.suspendUserPing),
        ...
        /// <summary>
        /// This method is called when server receives a <b>UtilComponent::getPssConfig</b> command.<br/>
        /// Request type: <see cref="EmptyMessage"/><br/>
        /// Response type: <see cref="PssConfig"/><br/>
        /// </summary>
        public virtual Task<PssConfig> GetPssConfigAsync(EmptyMessage request, BlazeRpcContext context)
        {
            throw new UtilException(ServerError.ERR_COMMAND_NOT_FOUND);
        }
