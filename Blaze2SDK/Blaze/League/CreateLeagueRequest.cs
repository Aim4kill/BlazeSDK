...
public class CreateLeagueRequest : Tdf
{
    ...
    private TdfEnum<Blaze2SDK.Blaze.League.LeagueFlags> _leagueFlags = new(__typeInfos[4]);
    ...
    private TdfList<uint> _options = new(__typeInfos[9]);
    private TdfString _password = new(__typeInfos[10]);
    private TdfUInt8 _numPlayoffGames = new(__typeInfos[11]);
    private TdfEnum<Blaze2SDK.Blaze.League.PlayoffType> _playoffType = new(__typeInfos[12]);
    ...
    private TdfEnum<Blaze2SDK.Blaze.League.ScheduleType> _scheduleType = new(__typeInfos[16]);
    ...
    private TdfEnum<Blaze2SDK.Blaze.League.TradeType> _tradeType = new(__typeInfos[20]);
