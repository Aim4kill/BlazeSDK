...
public class GameReportColumn : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("EntityType", "mEntityType", 0x974E7000, TdfType.ObjectType, 4, true), // ETYP
    ...
    private TdfObjectType _entityType = new(__typeInfos[4]);
    ...
    public override string GetFullClassName() => "Blaze::GameReportingLegacy::GameReportColumn";
