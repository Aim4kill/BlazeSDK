...
public class RegistrationRemrowRequest : Tdf
{
    ...
    public RegistrationRemrowRequest()
    {
        __members = [
            _eventID,
            _gamePlatform,
    ...
    public override Tdf CreateNew() => new RegistrationRemrowRequest();
    public override ITdfMember[] GetMembers() => __members;
    public override TdfMemberInfo[] GetMemberInfos() => __typeInfos;
    public static TdfMemberInfo[] GetTdfMemberInfos() => __typeInfos;
    public override string GetClassName() => "RegistrationRemrowRequest";
    public override string GetFullClassName() => "Blaze::Registration::RegistrationRemrowRequest";
