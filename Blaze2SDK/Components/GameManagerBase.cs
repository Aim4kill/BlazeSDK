...
namespace Blaze2SDK.Components
{
    public static class GameManagerBase
    {
        ...
        public class Client : BlazeClientComponent<GameManagerCommand, GameManagerNotification, Blaze2RpcError>
        {
            ...
            {
                _logger.Warn($"{GetType().FullName}: OnNotifyMatchmakingFinishedAsync NOT IMPLEMENTED!");
            ...
            {
                _logger.Warn($"{GetType().FullName}: OnNotifyJoinGameAsync NOT IMPLEMENTED!");
                return Task.CompletedTask;
            }
            ...
            {
                _logger.Warn($"{GetType().FullName}: OnNotifyGroupPreJoinedGameAsync NOT IMPLEMENTED!");
                return Task.CompletedTask;
            }
            ...
            {
                _logger.Warn($"{GetType().FullName}: OnNotifyQueueChangedAsync NOT IMPLEMENTED!");
                return Task.CompletedTask;
            }
