...
public class RankedGameRulePrefs : Tdf
{
    ...
    private TdfEnum<Blaze3SDK.Blaze.GameManager.RankedGameRulePrefs.RankedGameDesiredValue> _desiredRankedGameValue = new(__typeInfos[1]);
    ...
    public Blaze3SDK.Blaze.GameManager.RankedGameRulePrefs.RankedGameDesiredValue DesiredRankedGameValue
    {
