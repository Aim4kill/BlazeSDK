...
public class PricePoints : Tdf
{
    ...
    private TdfList<Blaze2SDK.Blaze.CommerceInfo.PricePoint> _pricePointVector = new(__typeInfos[0]);
    ...
    public IList<Blaze2SDK.Blaze.CommerceInfo.PricePoint> PricePointVector
    {
