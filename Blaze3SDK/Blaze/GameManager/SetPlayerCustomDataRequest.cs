...
public class SetPlayerCustomDataRequest : Tdf
{
    ...
    public SetPlayerCustomDataRequest()
    {
        __members = [
            _customData,
            _gameId,
    ...
    public override Tdf CreateNew() => new SetPlayerCustomDataRequest();
    public override ITdfMember[] GetMembers() => __members;
    public override TdfMemberInfo[] GetMemberInfos() => __typeInfos;
    public static TdfMemberInfo[] GetTdfMemberInfos() => __typeInfos;
    public override string GetClassName() => "SetPlayerCustomDataRequest";
    public override string GetFullClassName() => "Blaze::GameManager::SetPlayerCustomDataRequest";
