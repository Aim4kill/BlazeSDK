...
public class JoinTournamentResponse : Tdf
{
    ...
    private TdfStruct<Blaze2SDK.Blaze.Tournaments.TournamentData?> _tournament = new(__typeInfos[0]);
    ...
    public Blaze2SDK.Blaze.Tournaments.TournamentData? Tournament
    {
