...
public class QosConfigInfo : Tdf
{
    ...
    private TdfStruct<Blaze3SDK.Blaze.QosPingSiteInfo?> _bandwidthPingSiteInfo = new(__typeInfos[0]);
    private TdfUInt16 _numLatencyProbes = new(__typeInfos[1]);
    private TdfMap<string, Blaze3SDK.Blaze.QosPingSiteInfo> _pingSiteInfoByAliasMap = new(__typeInfos[2]);
    ...
    public Blaze3SDK.Blaze.QosPingSiteInfo? BandwidthPingSiteInfo
    {
    ...
    public IDictionary<string, Blaze3SDK.Blaze.QosPingSiteInfo> PingSiteInfoByAliasMap
    {
