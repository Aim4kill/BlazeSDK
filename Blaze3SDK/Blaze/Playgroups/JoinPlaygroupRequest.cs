...
public class JoinPlaygroupRequest : Tdf
{
    ...
    private TdfUnion<Blaze3SDK.Blaze.NetworkAddress> _networkAddress = new(__typeInfos[1]);
    private TdfString _uniqueKey = new(__typeInfos[2]);
    private TdfStruct<Blaze3SDK.Blaze.UserIdentification?> _user = new(__typeInfos[3]);
