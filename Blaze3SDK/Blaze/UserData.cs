...
public class UserData : Tdf
{
    ...
    private TdfEnum<Blaze3SDK.Blaze.UserDataFlags> _statusFlags = new(__typeInfos[1]);
    private TdfStruct<Blaze3SDK.Blaze.UserIdentification?> _userInfo = new(__typeInfos[2]);
