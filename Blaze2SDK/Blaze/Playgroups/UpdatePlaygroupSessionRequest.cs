...
public class UpdatePlaygroupSessionRequest : Tdf
{
    ...
    public UpdatePlaygroupSessionRequest()
    {
        __members = [
            _id,
            _xnetNonce,
    ...
    public override Tdf CreateNew() => new UpdatePlaygroupSessionRequest();
    public override ITdfMember[] GetMembers() => __members;
    public override TdfMemberInfo[] GetMemberInfos() => __typeInfos;
    public static TdfMemberInfo[] GetTdfMemberInfos() => __typeInfos;
    public override string GetClassName() => "UpdatePlaygroupSessionRequest";
    public override string GetFullClassName() => "Blaze::Playgroups::UpdatePlaygroupSessionRequest";
