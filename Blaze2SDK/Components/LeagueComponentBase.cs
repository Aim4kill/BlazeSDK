...
namespace Blaze2SDK.Components
{
    public static class LeagueComponentBase
    {
        ...
        public class Server : BlazeComponent<LeagueComponentCommand, LeagueComponentNotification, Blaze2RpcError>
        {
        ...
        public class Client : BlazeComponent<LeagueComponentCommand, LeagueComponentNotification, Blaze2RpcError>
        {
