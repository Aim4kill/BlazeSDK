...
public class ServerInstanceInfo : Tdf
{
    ...
    private TdfUnion<Blaze3SDK.Blaze.Redirector.ServerAddress> _address = new(__typeInfos[0]);
    private TdfList<Blaze3SDK.Blaze.Redirector.AddressRemapEntry> _addressRemaps = new(__typeInfos[1]);
    private TdfList<string> _messages = new(__typeInfos[2]);
    private TdfList<Blaze3SDK.Blaze.Redirector.NameRemapEntry> _nameRemaps = new(__typeInfos[3]);
    ...
    public Blaze3SDK.Blaze.Redirector.ServerAddress Address
    {
        get => _address.Value;
