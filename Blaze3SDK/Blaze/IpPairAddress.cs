...
public class IpPairAddress : Tdf
{
    ...
    private TdfStruct<Blaze3SDK.Blaze.IpAddress?> _externalAddress = new(__typeInfos[0]);
    private TdfStruct<Blaze3SDK.Blaze.IpAddress?> _internalAddress = new(__typeInfos[1]);
    ...
    public Blaze3SDK.Blaze.IpAddress? ExternalAddress
    {
        get => _externalAddress.Value;
        set => _externalAddress.Value = value;
    }

    public Blaze3SDK.Blaze.IpAddress? InternalAddress
    {
