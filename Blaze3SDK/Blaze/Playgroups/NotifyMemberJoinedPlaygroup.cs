...
public class NotifyMemberJoinedPlaygroup : Tdf
{
    ...
    private TdfStruct<Blaze3SDK.Blaze.Playgroups.PlaygroupMemberInfo?> _playgroupMemberInfo = new(__typeInfos[0]);
    ...
    public Blaze3SDK.Blaze.Playgroups.PlaygroupMemberInfo? PlaygroupMemberInfo
    {
