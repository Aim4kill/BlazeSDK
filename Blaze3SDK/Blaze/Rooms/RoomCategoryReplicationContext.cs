...
public class RoomCategoryReplicationContext : Tdf
{
    ...
    private TdfEnum<Blaze3SDK.Blaze.Rooms.RoomCategoryReplicationContext.RoomCategoryUpdateReason> _updateReason = new(__typeInfos[1]);
    ...
    public Blaze3SDK.Blaze.Rooms.RoomCategoryReplicationContext.RoomCategoryUpdateReason UpdateReason
    {
