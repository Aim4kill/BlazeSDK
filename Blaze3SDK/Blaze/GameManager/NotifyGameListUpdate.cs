...
public class NotifyGameListUpdate : Tdf
{
    ...
    private TdfList<Blaze3SDK.Blaze.GameManager.GameBrowserMatchData> _updatedGames = new(__typeInfos[3]);
    ...
    public IList<Blaze3SDK.Blaze.GameManager.GameBrowserMatchData> UpdatedGames
    {
