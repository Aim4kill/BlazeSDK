...
public class TournamentNode : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("UserOneId", "mUserOneId", 0xD6992F00, TdfType.UInt32, 11, true), // UIDO
        new TdfMemberInfo("UserTwoId", "mUserTwoId", 0xD6993400, TdfType.UInt32, 12, true), // UIDT
    ];
    ...
    private TdfUInt32 _userOneId = new(__typeInfos[11]);
    private TdfUInt32 _userTwoId = new(__typeInfos[12]);
