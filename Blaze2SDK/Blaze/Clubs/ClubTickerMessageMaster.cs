...
public class ClubTickerMessageMaster : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("ExcludeUserId", "mExcludeUserId", 0x978D6900, TdfType.UInt32, 2, true), // EXUI
        new TdfMemberInfo("IncludeUserId", "mIncludeUserId", 0xA6ED6900, TdfType.UInt32, 3, true), // INUI
        new TdfMemberInfo("Params", "mParams", 0xC32B7300, TdfType.String, 4, true), // PRMS
    ];
    private ITdfMember[] __members;

    private TdfUInt32 _clubId = new(__typeInfos[0]);
    private TdfStruct<Blaze2SDK.Blaze.Clubs.ClubTickerMessage?> _message = new(__typeInfos[1]);
    private TdfUInt32 _excludeUserId = new(__typeInfos[2]);
    private TdfUInt32 _includeUserId = new(__typeInfos[3]);
    ...
    public Blaze2SDK.Blaze.Clubs.ClubTickerMessage? Message
    {
        get => _message.Value;
        set => _message.Value = value;
    }

    public uint ExcludeUserId
    {
        get => _excludeUserId.Value;
        set => _excludeUserId.Value = value;
    }

    public uint IncludeUserId
    {
